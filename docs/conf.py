...
htmlhelp_basename = 'Django-shardingdoc'
...
latex_documents = [
    (master_doc, 'Django-sharding.tex', 'Django-sharding Documentation',
     'Patchman B.V.', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'Django-sharding', 'Django-sharding Documentation',
     author, 'Django-sharding', 'One line description of project.',
     'Miscellaneous'),
]
