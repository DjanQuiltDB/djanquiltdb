...
class PurgeSchemaTestCase(ShardingTestCase):
    ...
    @mock.patch('sharding.management.commands.purge_schema.Command.get_node', return_value='some node')
    @mock.patch('sharding.management.commands.purge_schema.ShardOptions')
    @mock.patch('sharding.management.commands.purge_schema.Command.get_schema_name', return_value='some schema')
    @mock.patch('sharding.management.commands.purge_schema.Command.confirm')
    @mock.patch('sharding.management.commands.purge_schema.Command.delete_schema')
