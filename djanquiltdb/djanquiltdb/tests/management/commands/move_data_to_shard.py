...
class MoveDataToShardTestCase(ShardingTestCase):
    ...
    @mock.patch('djanquiltdb.management.commands.move_data_to_shard.Command.pre_execution')
    @mock.patch('djanquiltdb.management.commands.move_data_to_shard.Command.get_objects')
    @mock.patch('djanquiltdb.management.commands.move_data_to_shard.Command.get_data_collector')
    @mock.patch('djanquiltdb.management.commands.move_data_to_shard.Command.reset_sequencers')
    ...
    @mock.patch('djanquiltdb.management.commands.move_data_to_shard.transaction_for_nodes')
    ...
    @mock.patch('djanquiltdb.management.commands.move_data_to_shard.SimpleCollector.collect')
    ...
    @mock.patch('djanquiltdb.management.commands.move_data_to_shard.NestedObjects.collect')
    ...
    @mock.patch('djanquiltdb.management.commands.move_data_to_shard.Command.validate_data_integrity')
    ...
    @mock.patch('djanquiltdb.management.commands.move_data_to_shard.Command.copy_data', side_effect=DatabaseError)
    @mock.patch('djanquiltdb.management.commands.move_data_to_shard.Command.post_execution')
    ...
    @mock.patch('djanquiltdb.management.commands.move_data_to_shard.SimpleCollector')
